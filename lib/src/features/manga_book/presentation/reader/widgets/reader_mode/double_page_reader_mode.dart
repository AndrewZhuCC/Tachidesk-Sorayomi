...
class DoublePageReaderMode extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      ...
      int currentPage = currentIndex.value * 2;
      // Prev page
      if (currentPage > 0) {
        ...
        itemBuilder: (BuildContext context, int index) {
          ...
          if (pageIndex + 1 < chapter.pageCount.getValueOnNullOrNegative()) {
            image2 = ServerImage(
              ...
              size: Size.fromHeight(context.height),
              appendApiToUrl: true,
              imageUrl: chapterPages.pages[pageIndex + 1],
              progressIndicatorBuilder: (context, url, downloadProgress) => CenterSorayomiShimmerIndicator(
                value: downloadProgress.progress,
              ),
          ...
          return AppUtils.wrapOn(
            ...
            SizedBox(
                ...
                child: Row(
                    ...
                    children: [
                      LimitedBox(maxWidth: context.width * .5, child: reverse ? image2 : image),
                      LimitedBox(maxWidth: context.width * .5, child: reverse ? image : image2),
                    ])),
          );
        },
