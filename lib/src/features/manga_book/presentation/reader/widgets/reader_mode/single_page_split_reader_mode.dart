...
class SinglePageSplitReaderMode extends HookConsumerWidget {
  const SinglePageSplitReaderMode({
    super.key,
    required this.manga,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useEffect(() {
      ...
      int currentPage = (currentIndex.value / 2).floor();
      // Prev page
      if (currentPage > 0) {
